...
<html>
    <head>
        ...
        <link rel="apple-touch-icon" href="./img/mobileenrollment.png">
    </head>
    <body>
        ...
        <div class="container">
            <form action="StudentLogon" method="post" id="loginForm">
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">Note: this is your Student ID, not email or username</small>
                <div class="form-group">
