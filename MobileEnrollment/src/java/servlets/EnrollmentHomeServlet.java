...
public class EnrollmentHomeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            depts = DepartmentDB.getDepts();
            if (depts == null ) {
                System.out.println("Select dept servlet error");
                msg = "Departments returned null. <br>";
                URL = "/StudentHub.jsp";
            } else {
                request.getSession().setAttribute("depts", depts);
            }
        } catch(Exception e) {
            msg = "Department Select Servlet Error: " + e.getMessage();
            URL = "/StudentHub.jsp";
        }
